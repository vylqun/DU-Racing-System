...
-- Params
raceEventName = "Wonderland" --export: This should be set to match the raceEventName used on the central system (keep the "")
...
testTrackName = "Wonderland" --export: Active track name, only used for test races (keep the "")
maxLaps = 5 --export: Number of laps for this event, set 0 if you want to use the default number of laps
